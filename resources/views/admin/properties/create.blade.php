    ...
    <div class="card-body">
        ...
        <form class="form-horizontal"
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input value="{{ old('title') }}" class="form-control" id="title" type="text" name="title" placeholder="Property Tame">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-md-3 col-form-label" for="slug">Slug Name(Auto)</label>
                <div class="col-md-9">
                    <input value="{{ old('slug') }}" class="form-control" id="slug" type="text" name="slug">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input value="{{ old('introduction') }}" class="form-control" id="introduction" type="text" name="introduction" placeholder="Property Introduction">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9 col-form-label">
                    ...
                    <div class="form-check form-check-inline mr-1">
                        <input class="form-check-input" id="Both" type="radio" value="Both" name="type">
